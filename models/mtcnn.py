...
from models.utils.detect_face import detect_face, extract_face
    ...
    def forward(self, img, save_path=None, return_prob=False):
        ...
        for im, box_im, prob_im, path_im in zip(img, batch_boxes, batch_probs, save_path):
            ...
            for i, box in enumerate(box_im):
                ...
                face, im_face = extract_face(im, box, self.image_size, self.margin, face_path)
                im_faces.append(im_face) # KWON
        ...
        if return_prob:
            return faces, im_faces, probs
        else:
            return faces, im_faces
